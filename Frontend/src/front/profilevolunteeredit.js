...
function Profilevolunteeredit() {
    ...
    <div className="pro">
        ...
        <button className="clickedit" onClick={handleSubmit}>
              EDIT
            </button>
        ...
        <input type="text" class="search-input" placeholder="What do you want to say..."></input>
        <button class="search-button">POST</button>
        </div>  
    </div>
